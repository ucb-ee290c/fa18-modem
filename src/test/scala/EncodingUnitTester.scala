...
//  expect(c.io.in.ready, 1)
  ...
  expect(c.io.out.bits.bits(2), 0)
  expect(c.io.out.bits.bits(3), 0)
  expect(c.io.out.bits.bits(4), 0)
  expect(c.io.out.bits.bits(5), 0)
  expect(c.io.out.valid, 0)
  expect(c.io.in.ready, 1)
  poke(c.io.in.bits, 1)
...
//step(1) // state: 10
//expect(c.io.out.bits.bits(0), 1)
//expect(c.io.out.bits.bits(1), 1) // <- output: '11', next state: 10
//expect(c.io.out.bits.bits(2), 0)
//expect(c.io.out.bits.bits(3), 0)
//expect(c.io.out.bits.bits(4), 0)
//expect(c.io.out.bits.bits(5), 0)
...
//expect(c.io.out.bits.bits(0), 1)
//expect(c.io.out.bits.bits(1), 1)
//expect(c.io.out.bits.bits(2), 0) // <- output: '0'1, next state: 11
//expect(c.io.out.bits.bits(3), 0)
//expect(c.io.out.bits.bits(4), 0)
//expect(c.io.out.bits.bits(5), 0)
//expect(c.io.out.valid, 0)
...
//expect(c.io.out.bits.bits(1), 1)
//expect(c.io.out.bits.bits(2), 0)
//expect(c.io.out.bits.bits(3), 0) // <- output: 1'0', next state: 11
//expect(c.io.out.bits.bits(4), 0)
//expect(c.io.out.bits.bits(5), 0)
//expect(c.io.out.valid, 0)
//expect(c.io.in.ready, 1)
...
//expect(c.io.out.bits.bits(3), 0)
//expect(c.io.out.bits.bits(4), 1)
//expect(c.io.out.bits.bits(5), 0) // <- output: '10', next state: 11
//expect(c.io.out.valid, 1)
//expect(c.io.in.ready, 1)
//poke(c.io.in.bits, 0)
//
//step(1) // state: 10
//expect(c.io.out.bits.bits(0), 0) // <- output: '0'1, next state: 01
//expect(c.io.out.bits.bits(1), 1)
//expect(c.io.out.bits.bits(2), 0)
//expect(c.io.out.bits.bits(3), 0)
//expect(c.io.out.bits.bits(4), 1)
...
//step(1) // state: 10
//expect(c.io.out.bits.bits(0), 0)
//expect(c.io.out.bits.bits(1), 1) // <- output: 0'1', next state: 00
//expect(c.io.out.bits.bits(2), 0)
//expect(c.io.out.bits.bits(3), 0)
//expect(c.io.out.bits.bits(4), 1)
//expect(c.io.out.bits.bits(5), 0)
...
//expect(c.io.out.bits.bits(3), 1) // <- output: '11', next state: 10
//expect(c.io.out.bits.bits(4), 1)
//expect(c.io.out.bits.bits(5), 0)
//expect(c.io.out.valid, 0)
//expect(c.io.in.ready, 1)
...
//expect(c.io.out.bits.bits(2), 1)
//expect(c.io.out.bits.bits(3), 1)
//expect(c.io.out.bits.bits(4), 0) // <- output: '0'1, next state: 11
//expect(c.io.out.bits.bits(5), 0)
//expect(c.io.out.valid, 0)
//expect(c.io.in.ready, 1)
//poke(c.io.in.bits, 1)
...
//expect(c.io.out.bits.bits(3), 1)
//expect(c.io.out.bits.bits(4), 0)
//expect(c.io.out.bits.bits(5), 0) // <- output: 1'0', next state: 11
//expect(c.io.out.valid, 1)
//expect(c.io.in.ready, 1)
//poke(c.io.in.bits, 1)